...
Gem::Specification.new do |spec|
  ...
  spec.summary     = "Pinmark — pin-style annotations for live UI feedback into Claude Code."
  spec.description = "Pinmark — pin-style annotations for live UI feedback into Claude Code. " \
                     "Adds a development-only overlay that lets a designer annotate any " \
