...
RSpec.describe "Dev pinmark endpoint", type: :request do
  ...
  def jsonrpc(method, params: nil, id: 1, session_id: nil)
    ...
    post "/dev/pinmark/annotations/mcp", params: body.to_json, headers:
  end
  ...
  it "lists the four annotation tools" do
  ...
  it "exposes node_id and text_excerpt in list_pending_annotations output" do
    ...
    expect(entry["node_id"]).to eq("pm-42")
